...
export const NAV_ITEMS: NavItem[] = [
  { href: "/admin", label: "Dashboard", icon: LayoutDashboard, roles: ["admin"], group: "main" },
  { href: "/admin/membros", label: "Membros", icon: Users, roles: ["admin"], group: "main" },
  { href: "/admin/aprovacoes", label: "Aprovações", icon: UserCheck, roles: ["admin"], group: "main" },
