...
const MEMBER_COLUMNS =
  "id, profile_id, full_name, display_name, slug, email, phone, city, state, bio, photo_url, company, position, occupation_areas, status, is_public, approved_at, company_name, company_type, company_stage, company_cnpj, company_logo_url, company_problem, company_sector, company_review_status, company_mrr, company_subscribers"
